 ...
 *
 * @ORM\Table(name="menu")
 * @ORM\Entity(repositoryClass="Core\MenuBundle\Entity\MenuRepository")
 */
class Menu
{
    /**
     ...
     * Set padre
     *
     * @param \Core\MenuBundle\Entity\Menu $padre
     * @return Menu
     */
    public function setPadre(\Core\MenuBundle\Entity\Menu $padre = null)
    {
        $this->padre = $padre;
     ...
     * Get padre
     *
     * @return \Core\MenuBundle\Entity\Menu 
     */
     ...
     * Add hijos
     *
     * @param \Core\MenuBundle\Entity\Menu $hijos
     * @return Menu
     */
    public function addHijo(\Core\MenuBundle\Entity\Menu $hijos)
    {
        $this->hijos[] = $hijos;
     ...
     * @param \Core\MenuBundle\Entity\Menu $hijos
     */
    public function removeHijo(\Core\MenuBundle\Entity\Menu $hijos)
    {
