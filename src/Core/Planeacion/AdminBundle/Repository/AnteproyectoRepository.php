...
class AnteproyectoRepository extends \Core\ComunBundle\Util\NomencladoresRepository
{
        ...
        if (count($periodo) > 0) 
         ...
         foreach ($profePeriodoHorarios as $profePeriodoAntep) {
           ...
           //eliminar los horarios generados para este periodo
             ...
             $profePeriodoHorario = new \Core\Planeacion\AdminBundle\Entity\ProfePeriodoHorario();
           ...
           //                  find(\Core\Planeacion\AdminBundle\Enums\EEstadoHorario::Aprobado));
