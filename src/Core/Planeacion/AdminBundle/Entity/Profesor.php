...
use Core\Planeacion\AdminBundle\Enums\EPerfilAcademico;
...
class Profesor
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Core\Planeacion\AdminBundle\Entity\DescargaAdministrativa", mappedBy="profesor", cascade={"persist","remove"})
     */
    private $descarga;
    /**
     * @var \IdiomaProfe
...
//        ld($this->getGenero());
    ...
    public function getCarreraImparteString()
    {
     ...
     * Add descarga
     *
     * @param \Core\Planeacion\AdminBundle\Entity\DescargaAdministrativa $descarga
     * @return DescargaAdministrativa
     */
    public function addDescarga(\Core\Planeacion\AdminBundle\Entity\DescargaAdministrativa $descarga)
    {
     ...
     * @param \Core\Planeacion\AdminBundle\Entity\DescargaAdministrativa $descarga
     */
    public function removeDescarga(\Core\Planeacion\AdminBundle\Entity\DescargaAdministrativa $descarga)
    {
