...
class ProfePeriodo
{
     ...
     * @return ProfePeriodo
     */
    public function addGrupoHorarioAnteproyectoo(\Core\Planeacion\AdminBundle\Entity\GrupoHorarioAnteproyecto $profePeriodoHorario)
    {
        $profePeriodoHorario->setProfePeriodo($this);
     ...
     * Remove profePeriodoHorario
     *
     * @param \Core\Planeacion\AdminBundle\Entity\GrupoHorarioAnteproyecto $profePeriodoHorario
     */
    public function removeGrupoHorarioAnteproyecto(\Core\Planeacion\AdminBundle\Entity\GrupoHorarioAnteproyecto $profePeriodoHorario)
    {
     ...
     *
     * @param \Core\Planeacion\AdminBundle\Entity\Materia $historicoMateriaManual
     * @return ProfePeriodo
     */
    public function addHistoricoMateriaManual(\Core\Planeacion\AdminBundle\Entity\Materia $historicoMateriaManual)
    {
     ...
     * @param \Core\Planeacion\AdminBundle\Entity\Materia $historicoMateriaManual
     */
    public function removeHistoricoMateriaManual(\Core\Planeacion\AdminBundle\Entity\Materia $historicoMateriaManual)
    {
