 ...
 * * @ORM\Entity(repositoryClass="Core\Planeacion\AdminBundle\Repository\GrupoHorarioAnteproyectoRepository")
 */
...
//        ldd($dia);
     ...
     * Set grupo
     *
     * @param \Core\Planeacion\AdminBundle\Entity\ProfePeriodo $grupo
     * @return ProfePeriodoHorario
     */
    public function setProfePeriodo(\Core\Planeacion\AdminBundle\Entity\ProfePeriodo $grupo = null)
    {
