 ...
 * @ORM\Entity(repositoryClass="Core\Planeacion\AdminBundle\Repository\EstudianteRepository")
 */
class Estudiante
{
    /**
   ...
   /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="Core\MySecurityBundle\Entity\Usuario", inversedBy="estudiante",cascade={"persist","remove"})
     * @ORM\JoinColumns({
...
//        ld($this->getGenero());
     ...
     * @return Persona
     */
    public function setFechaActualizacion($fechaNacimiento)
    {
        $this->fechaActualizacion = $fechaNacimiento;
