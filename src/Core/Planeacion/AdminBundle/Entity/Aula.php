 ...
 * @ORM\Entity(repositoryClass="Core\Planeacion\AdminBundle\Repository\AulaRepository")
...
class Aula
{
     ...
     * @return Aula
     */
    public function addGrupo(\Core\Planeacion\AdminBundle\Entity\GrupoEstudiantes $grupo)
    {
        $this->grupo[] = $grupo;
     ...
     * @param \Core\Planeacion\AdminBundle\Entity\GrupoEstudiantes $grupo
     */
    public function removeGrupo(\Core\Planeacion\AdminBundle\Entity\GrupoEstudiantes $grupo)
    {
     ...
     * Add grupo
     *
     * @param \Core\Planeacion\AdminBundle\Entity\ProfePeriodoHorario $grupo
     * @return Aula
     */
    public function addProfePeriodoHorario(\Core\Planeacion\AdminBundle\Entity\ProfePeriodoHorario $grupo)
    {
     ...
     * @param \Core\Planeacion\AdminBundle\Entity\ProfePeriodoHorario $grupo
     */
    public function removeProfePeriodoHorario(\Core\Planeacion\AdminBundle\Entity\ProfePeriodoHorario $profe)
    {
