...
use Core\MySecurityBundle\Entity\Grupo;
use Core\MySecurityBundle\Form\GroupType;
use Core\MySecurityBundle\TreeDescription\GroupPermissionTree;
use Symfony\Component\HttpFoundation\JsonResponse;

class GroupController extends MyCRUDController
{
    protected $type = 'Core\MySecurityBundle\Form\GroupType';
