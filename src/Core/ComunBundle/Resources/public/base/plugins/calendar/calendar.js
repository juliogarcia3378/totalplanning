        ...
        initCalendar: function (eventos) {
            ...
            var calendar= $('#calendar').fullCalendar({
                ...
                select: function(start, end, allDay) {
                    ...
                    titulo= $("#Core_comunbundle_evento_calendario_type_denominacion").val();
                    descripcion = $("#Core_comunbundle_evento_calendario_type_descripcion").val();
                    tiempoCompleto= $("#Core_comunbundle_evento_calendario_type_tiempoCompleto").val();
