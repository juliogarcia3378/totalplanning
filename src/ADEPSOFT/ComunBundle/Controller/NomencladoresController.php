...
//        $obj = $repo->generateEnumFromCollection($repo->filterObjects(array('tipoEstado'=> \ADEPSOFT\ComunBundle\Enums\ETipoEstado::Tramite)),'EEstadoTramite');
//        $obj = $repo->generateEnumToEntity();
//        $var['total']= UtilRepository2::getSession()->get('total');
//        ld($table);
//        ldd(\ADEPSOFT\ComunBundle\Util\UtilRepository2::getEntityManager()->getRepository('ComunBundle:'.$table)->filterObjects());
//        ldd(\ADEPSOFT\BiomexpressServicesBundle\Manager\BiomexpressServiceManager::authenticate(1, 1));
//       ldd($obj);
    }
}
