...
//        return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('request')->getSession()->get('poderJudicial');
    }
    public static function getUsuarioLogged($object = false)
    {
        ...
        if($object)
            return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('security.context')->getToken()->getUser();
        return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('security.context')->getToken()->getUser()->getId();
    }
//    public static function getPersonaLogged($object = false)
//    {
//        $idUser = \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('security.context')->getToken()->getUser()->getId();
//        if($object)
//            return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getEntityManager()->find('SeguridadBundle:Usuario',$idUser)->getPersonanatural();
//        return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getEntityManager()->find('SeguridadBundle:Usuario',$idUser)->getPersonanatural()->getId();
//    }
    ...
    {
        return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('doctrine.orm.entity_manager');
    }
    /**
    ...
    {
        return \ADEPSOFT\ComunBundle\Util\UtilRepository2::getContainer()->get('doctrine.orm.entity_manager')->getRepository($entity);
    }
    /**
     * @return Container
     */
