...
namespace ADEPSOFT\MenuBundle\Controller;

use ADEPSOFT\ComunBundle\Controller\BaseController;
use ADEPSOFT\MenuBundle\Entity\Menu;
...
//        ldd($this->getEm()->getRepository("BaseBundle:EventoCalendario")->obtenerEventosANotificar());
        return $this->render("ADEPSOFTMenuBundle:Default:index.html.twig");
    }
...
//    }
    ...
    {
        $menus = $this->get('doctrine.orm.entity_manager')->getRepository("ADEPSOFTMenuBundle:Menu")->findAll() ;
    ...
    {
        $menuParents = $this->get('doctrine.orm.entity_manager')->getRepository("ADEPSOFTMenuBundle:Menu")->obtenerPadres(false) ;
