...
use ADEPSOFT\MySecurityBundle\EP\UserInstanceEP;
use ADEPSOFT\MySecurityBundle\Form\UsuarioInstanciaType;
...
{
    protected $type = 'ADEPSOFT\MySecurityBundle\Form\UsuarioInstanciaType';
