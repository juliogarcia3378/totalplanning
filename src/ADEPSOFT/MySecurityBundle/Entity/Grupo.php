 ...
 * @ORM\Entity(repositoryClass="ADEPSOFT\MySecurityBundle\Repository\GrupoRepository")
 */
class Grupo extends Group
{
     ...
     * Add permiso
     *
     * @param \ADEPSOFT\MySecurityBundle\Entity\Permission $permiso
     * @return Grupo
     */
    public function addPermiso(\ADEPSOFT\MySecurityBundle\Entity\Permission $permiso)
    {
     ...
     * @param \ADEPSOFT\MySecurityBundle\Entity\Permission $permiso
     */
    public function removePermiso(\ADEPSOFT\MySecurityBundle\Entity\Permission $permiso)
    {
     ...
     * Add usuarios
     *
     * @param \ADEPSOFT\MySecurityBundle\Entity\Usuario $usuarios
     * @return Grupo
     */
    public function addUsuario(\ADEPSOFT\MySecurityBundle\Entity\Usuario $usuarios)
    {
     ...
     * @param \ADEPSOFT\MySecurityBundle\Entity\Usuario $usuarios
     */
    public function removeUsuario(\ADEPSOFT\MySecurityBundle\Entity\Usuario $usuarios)
    {
