...
use ADEPSOFT\MySecurityBundle\Enums\EGroup;
 ...
 * @ORM\Entity(repositoryClass="ADEPSOFT\MySecurityBundle\Repository\UsuarioRepository")
 */
class Usuario extends User
{
    ...
    protected $groups;
    /**
     * @var \ADEPSOFT\Planeacion\AdminBundle\Entity\Profesor
     *
     * @ORM\OneToMany(targetEntity="ADEPSOFT\Planeacion\AdminBundle\Entity\Profesor",mappedBy="usuario")
     */
    private $profesor;
...
//        ldd('paco');
  ...
  /**
     ...
     * Add permisos
     *
     * @param \ADEPSOFT\MySecurityBundle\Entity\Permission $permisos
     * @return Usuario
     */
    public function addPermiso(\ADEPSOFT\MySecurityBundle\Entity\Permission $permisos)
    {
     ...
     * @param \ADEPSOFT\MySecurityBundle\Entity\Permission $permisos
     */
    public function removePermiso(\ADEPSOFT\MySecurityBundle\Entity\Permission $permisos)
    {
