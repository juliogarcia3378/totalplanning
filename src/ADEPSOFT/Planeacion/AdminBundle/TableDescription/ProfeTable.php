...
use ADEPSOFT\Planeacion\AdminBundle\TableDescription\Rutas\RutasProfesor;
...
class ProfeTable extends TableModel
{
    function __construct() {
        parent::__construct();
        $this->entity = 'ADEPSOFT\Planeacion\AdminBundle\Entity\Profesor';
...
//                $ids[]=$row->getId();
            ...
            $tmpArray[] = $row->getLiceImparteString();
