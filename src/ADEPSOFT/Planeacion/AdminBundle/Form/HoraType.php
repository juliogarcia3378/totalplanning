...
use ADEPSOFT\Planeacion\AdminBundle\Repository\DiaRepository;
...
//                   'data'=>$options['data']->getHora() == null ? null: array('hour'=>$options['data']->getHora()->format('H'),'minute'=>$options['data']->getHora()->format('i'))))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ADEPSOFT\Planeacion\AdminBundle\Entity\Hora'
        ));
    }

    public function getName()
    {
        return 'adepsoft_planeacion_adminbundle_horatype';
    }
}
