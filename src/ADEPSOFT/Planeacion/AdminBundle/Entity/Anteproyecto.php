 ...
 * @ORM\Entity(repositoryClass="ADEPSOFT\Planeacion\AdminBundle\Repository\AnteproyectoRepository")
 */
class Anteproyecto
{
    /**
 ...
 * @return ProfePeriodo
 */
    public function setPeriodoAnterior(\ADEPSOFT\Planeacion\AdminBundle\Entity\Periodo $periodo = null)
    {
     ...
     * Set periodo
     *
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\Estado $periodo
     * @return ProfePeriodo
     */
    public function setEstado(\ADEPSOFT\Planeacion\AdminBundle\Entity\Estado $estado= null)
    {
        $this->estado = $estado;
     ...
     * Get periodo
     *
     * @return \ADEPSOFT\Planeacion\AdminBundle\Entity\Estado
     */
