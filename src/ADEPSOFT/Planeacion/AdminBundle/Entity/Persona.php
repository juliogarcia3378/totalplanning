 ...
 * @ORM\DiscriminatorMap({"persona" = "Persona", "Estudiante" = "Estudiante"})
 */
class Persona
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="ADEPSOFT\MySecurityBundle\Entity\Usuario", inversedBy="Persona",cascade={"persist","remove"})
     * @ORM\JoinColumns({
