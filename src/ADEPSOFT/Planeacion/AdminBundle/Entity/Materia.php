 ...
 * @ORM\Entity(repositoryClass="ADEPSOFT\Planeacion\AdminBundle\Repository\MateriaRepository")
 */
class Materia
{
    /**
     ...
     * Set semestre
     *
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\Semestre $semestre
     * @return Materia
     */
    public function setSemestre(\ADEPSOFT\Planeacion\AdminBundle\Entity\Semestre $semestre = null)
    {
     ...
     * Get semestre
     *
     * @return \ADEPSOFT\Planeacion\AdminBundle\Entity\Semestre 
     */
     ...
     * @return Materia
     */
    public function setPlanEstudio(\ADEPSOFT\Planeacion\AdminBundle\Entity\PlanEstudio $planEstudio = null)
    {
     ...
     * Get planEstudio
     *
     * @return \ADEPSOFT\Planeacion\AdminBundle\Entity\PlanEstudio
     */
     ...
     *
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\ProfePeriodo $profePeriodoManual
     * @return Materia
     */
    public function addProfePeriodoManual(\ADEPSOFT\Planeacion\AdminBundle\Entity\ProfePeriodo $profePeriodoManual)
    {
     ...
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\ProfePeriodo $profePeriodoManual
     */
    public function removeProfePeriodoManual(\ADEPSOFT\Planeacion\AdminBundle\Entity\ProfePeriodo $profePeriodoManual)
    {
     ...
     * Set tipoMateria
     *
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\TipoMateria $tipoMateria
     * @return Materia
     */
    public function setTipoMateria(\ADEPSOFT\Planeacion\AdminBundle\Entity\TipoMateria $tipoMateria = null)
    {
     ...
     * Get tipoMateria
     *
     * @return \ADEPSOFT\Planeacion\AdminBundle\Entity\TipoMateria 
     */
     ...
     *
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\PreferenciaProfeMateria $preferenciaProfeMateria
     * @return Materia
     */
    public function addPreferenciaProfeMateria(\ADEPSOFT\Planeacion\AdminBundle\Entity\PreferenciaProfeMateria $preferenciaProfeMateria)
    {
     ...
     * @param \ADEPSOFT\Planeacion\AdminBundle\Entity\PreferenciaProfeMateria $preferenciaProfeMateria
     */
    public function removePreferenciaProfeMateria(\ADEPSOFT\Planeacion\AdminBundle\Entity\PreferenciaProfeMateria $preferenciaProfeMateria)
    {
