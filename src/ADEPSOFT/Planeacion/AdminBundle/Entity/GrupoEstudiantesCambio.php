 ...
 * @ORM\Entity(repositoryClass="ADEPSOFT\Planeacion\AdminBundle\Repository\GrupoEstudiantesCambioRepository")
 */
class GrupoEstudiantesCambio
{
    ...
    public function setAnteproyecto(\ADEPSOFT\Planeacion\AdminBundle\Entity\Anteproyecto $periodo = null)
    {
     ...
     * Get periodo
     *
     * @return \ADEPSOFT\Planeacion\AdminBundle\Entity\Anteproyecto
     */
